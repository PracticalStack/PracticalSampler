...
struct SamplerPlaybackContextCounters
{
    ...
    std::uint64_t dynamicReleaseUpdateCount = 0;
...
private:
    ...
    std::atomic<std::uint64_t> diagnosticDynamicReleaseUpdateCount { 0 };
    std::atomic<std::uint64_t> diagnosticRepedalCatchCount { 0 };
