...
const std::vector<CuratedDspEffectDescriptor>& getCuratedDspCatalog()
{
    static const std::vector<CuratedDspEffectDescriptor> catalog {
        { "drs.gain", 1, { CuratedDspScope::zone, CuratedDspScope::group, CuratedDspScope::layer, CuratedDspScope::instrument },
        ...
        { "drs.saturator", 1, { CuratedDspScope::zone, CuratedDspScope::group, CuratedDspScope::layer, CuratedDspScope::instrument },
        ...
        { "drs.stereoDelay", 1, { CuratedDspScope::zone, CuratedDspScope::group, CuratedDspScope::layer, CuratedDspScope::instrument },
        ...
        { "drs.algorithmicReverb", 1, { CuratedDspScope::zone, CuratedDspScope::group, CuratedDspScope::layer, CuratedDspScope::instrument },
        ...
        { "drs.compactEq", 1, { CuratedDspScope::zone, CuratedDspScope::group, CuratedDspScope::layer, CuratedDspScope::instrument },
        ...
        { "drs.chorus", 1, { CuratedDspScope::zone, CuratedDspScope::group, CuratedDspScope::layer, CuratedDspScope::instrument },
