...
int main(int argc, char** argv)
{
    try
    {
        ...
        report << "# Accurate Salamander large-instrument qualification\n\n"
               ...
               << "- Full-draft region prewarm intents accepted/rejected: "
               << fullPrepared.step.result.metrics.prewarmIntentCount << "/"
               << fullPrepared.step.result.metrics.rejectedPrewarmIntentCount << "\n"
