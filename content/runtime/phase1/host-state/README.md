...
| `negative/over-budget.fixture.json` | generated invalid | Deterministic recipe for synthesizing a payload one byte over the 2 MiB limit |
...
`over-budget.fixture.json` is a compact generator descriptor rather than a 2 MiB checked-in blob.
