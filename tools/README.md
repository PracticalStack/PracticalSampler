...
- `package-phase1-reference-instrument.ps1` builds the Phase 1 runtime fixture tool and either verifies or refreshes the checked-in tiny-open-instrument package metadata.
